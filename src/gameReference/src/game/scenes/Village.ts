...
export class Village extends BaseGameScene {
  ...
  preload() {
    ...
    this.load.spritesheet("Dead", "assets/Mob/Snail/Dead.png", {
      frameWidth: 48,
      frameHeight: 32,
    });
    this.load.spritesheet("Hide", "assets/Mob/Snail/Hide.png", {
      frameWidth: 48,
      frameHeight: 32,
    });
    this.load.spritesheet("Idle", "assets/Mob/Snail/Idle.png", {
      frameWidth: 48,
      frameHeight: 32,
    });
  ...
  async create() {
    ...
    this.room.state.spawnedPlayers.onAdd((player) => {
      ...
      this.anims.create({
        key: "Hide",
        frames: this.anims.generateFrameNumbers("Hide", {
          start: 0,
          end: 3,
        }),
        frameRate: 8,
